...
class Member {
    ...
    private String memberSolveOrder;
    ...
    String getMemberSolveOrder() { return (memberSolveOrder == null || memberSolveOrder.equals("")) ? "" : memberSolveOrder; }

    public void setMemberSolveOrder(String solveOrder) { this.memberSolveOrder = solveOrder; }
